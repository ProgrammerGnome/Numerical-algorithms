        ...
        for k = 1:min(m, n)
            ...
            switch local_pivot_type
                case 'partial'
                    ...
                    max_row = max_row + k - 1;
                    if max_val == 0
                        % Ha a pivot elem nulla, váltás teljes főelemkiválasztásra
                        disp('A részleges főelemkiválasztás nem lehetséges, áttérés teljes főelemkiválasztásra.');
...
x = gaussel2_lu_function(A, b, false, true, "full");
